"""Condition B ablation (generalised) — does performance depend on similar alleles?
...
def main():
    ...
    ap.add_argument("--family-regex", default=r"^HLA-A\\*02:",
                    help="alleles matching this regex are the 'family' removed in Condition B "
                         "(e.g. r'^HLA-A\\*(03|11):' for the A*03/A*11 supertype)")
    ...
    family = sorted(df[df[args.allele_col].str.match(args.family_regex)]
