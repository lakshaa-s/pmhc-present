...
def main():
    ...
    ap.add_argument("--split",
                    help="CSV of validation (allele, peptide) pairs from "
                         ...
                         "draw nothing else can reproduce, which is why the "
                         "earlier numbers from this script are not citable.")
    ...
    if args.split:
        ...
        print("Building cluster-based split (once) — NOT reproducible, prefer --split")
